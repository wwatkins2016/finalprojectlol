...
finished = false;
    ...
    function p_call(varargin)
        ...
        if (isempty(startyear) || (startyear > 2017) || (startyear < 1957))
            disp('Sorry, but your start year is wrong. Please enter a start year between 1957 and 2017.');
        end
        if (isempty(endyear) || (endyear > 2017) || (endyear < 1957))
            disp('Sorry, but your end year is wrong. Please enter a end year between 1957 and 2017.');
        end
        syear = startyear;
        eyear = endyear;
        types = checkedr;
